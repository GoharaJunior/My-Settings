...
2. Verifique se o teu VS Code está configurado para formatar ao salvar. Você precisa ter um arquivo _na raiz do projeto_como [.vscode/settings.json](https://github.com/React-Avancado/boilerplate/blob/master/.vscode/settings.json), segue abaixo o código:
